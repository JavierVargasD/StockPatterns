...
def ejecuteScript():
    ...
    try:
        ...
        data = json.load(urllib2.urlopen('https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY&amp;symbol=BABA&amp;interval=1min&amp;apikey=E5KJEEWP24PU8BH7&outputsize=full'))

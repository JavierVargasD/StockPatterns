...
def ejecuteScript():
    ...
    try:
        ...
        data = json.load(urllib2.urlopen('https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY&amp;symbol=TSLA&amp;interval=1min&amp;apikey=4NAVVQWAXRE1SGGY'))
...
def mock():
    ...
    data = json.load(urllib2.urlopen('https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY&amp;symbol=QCOM&amp;interval=1min&amp;apikey=E5KJEEWP24PU8BH7'))
    timeSeries1min = data['Time Series (1min)']; 
    ticker = data['Meta Data']['2. Symbol']; 
